// ======================================================================
// Task1Lab2UART.v generated from TopDesign.cysch
// 02/23/2026 at 11:45
...
module SW_Tx_UART_v1_50_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ae01e348-e28d-45aa-a5b2-31d7762ad25b/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("89879d90-4726-42a8-a676-9eb77dacc065"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d64afb05-a56c-402e-95dc-e9d9ec7b481d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
